...
var _a = require("./utils.js"), sendAutoMsg = _a.sendAutoMsg, pretreatMsg = _a.pretreatMsg;
function getWSS(port) {
    var _this = this;
    var app = new koa_1.default();
    app.use(koa_views_1.default(path_1.default.join(__dirname, "../view"), {
        extension: "ejs"
    }));
...
function setup(_a) {
    var port = _a.port, rule = _a.rule, autoMsgTimeout = _a.autoMsgTimeout;
    var wss = getWSS(port);
    ...
    wss.on("connection", function (ws, req) {
        ...
        ws.on("message", function (message) {
            ...
            if (rule && message)
                sendAutoMsg(ws, rule, message, autoMsgTimeout);
